...
```console
adafruit-macropad $ cargo build --release --example <name>
```
...
```console
adafruit-macropad $ cargo run --release --example <name>
```
...
6. Create a [New Pull Request](https://github.com/rp-rs/adafruit-macropad/pulls)
